                ...
                const SizedBox(height: 20,),
                 ...
                 Row(
                   ...
                   children: [
                     Column(
                       children: [
                         Image.asset('asset/images/voiceklip_logo_white.JPG', height: 180,),
                         const Text('Upload Main Display Photo',style: TextStyle(color: Colors.white, fontSize: 12),),
                          const SizedBox(height: 20,),
                          const MyTextField(hintText: 'Firstname', obscureText: false),
                          const SizedBox(height: 10,),
                          const MyTextField(hintText: 'Lastname', obscureText: false),
                          const SizedBox(height: 10,),
                          const MyTextField(hintText: 'Category', obscureText: false),
                          const SizedBox(height: 10,),
                          const MyTextField(hintText: 'Country', obscureText: false),
                          const SizedBox(height: 10,),
                          const MyTextField(hintText: 'Music Genre', obscureText: false),
                          const SizedBox(height: 10,),
                       ...
                       child: Column(
                         children: [
                           ...
                           Image.asset('asset/images/toyota_logo.png', height: 80,),
                            const SizedBox(height: 20,),
                           Image.asset('asset/images/voiceklip_logo_white.JPG', height: 120,),
                          const Text('Upload Home Display Photo',style: TextStyle(color: Colors.white, fontSize: 10),),
                         ],
                       ),
                     ),
                   ],
