...
class _TestTState extends State<TestT> with SingleTickerProviderStateMixin {
  void logout(BuildContext ctx) async {
    ...
    await ctx.read<AuthProvider>().signOut().then(
                ...
                Column(
                  children: [
                    ...
                    GridView.count(
                      ...
                      crossAxisSpacing:
                          16.0, // Adjust this value to control horizontal spacing
                        ...
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: const Color.fromARGB(255, 60, 167,
                                  255), // Customize the button color
                            ),
                            child: Center(
                              child: Text(
...
Widget _profileImage(BuildContext ctx) {
  final String user =
      Provider.of<AuthProvider>(ctx, listen: false).user?.email ??
          "Hello World";
  return Column(
    children: [
      Image.asset(
