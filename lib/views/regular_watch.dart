...
class RegularWatchVideo extends StatefulWidget {
  ...
  @override
  State<RegularWatchVideo> createState() => _RegularWatchVideoState();
}

class _RegularWatchVideoState extends State<RegularWatchVideo> {
                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      ...
                      textAlign: TextAlign
                          .justify, // Adjust the text alignment (e.g., TextAlign.center, TextAlign.left)
                    ),
                  ),
                  const SizedBox(
                    height: 20,
