                        ...
                        child: Row(
                          children: [
                            const SizedBox(width: 20,),
                                ...
                                Image.asset('asset/images/voiceklip_logo_only.png', height: 60,),
                  ...
                  child: Column(
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: const Text('SEE MAIN PROFILE', 
                        style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 12,
                        ...
                        child: Column(
                          children: [
                            GridView.count(
                              ...
                              crossAxisSpacing: 10.0, // Adjust this value to control horizontal spacing
                              ...
                              children: List.generate(5, (index) {
                                ...
                                return Padding(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(8.0), // Adjust the corner radius as needed
                                    color: Color.fromARGB(255, 255, 60, 60), // Customize the button color
                                  ),
