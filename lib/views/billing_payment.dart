              ...
              child: Column(
                ...
                const SizedBox(height: 20,),
                  Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                     Image.asset('asset/images/bpi_logo.png', height: 50,),
                      const SizedBox(width: 20.0,),
                      Image.asset('asset/images/metrobank_logo.png', height: 70,),
                 ...
                 Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                     Image.asset('asset/images/union_logo.jpg', height: 70,),
                      const SizedBox(width: 10.0,),
                      Image.asset('asset/images/securitybank_logo.jpg', height: 70,),
                      const SizedBox(width: 10.0,),
                      Image.asset('asset/images/paymaya_logo.png', height: 60,),
                      const SizedBox(width: 10.0,),
                      Image.asset('asset/images/gcash_logo.png', height: 70,),
                      ],
                    ), 
                        const SizedBox(height: 30,),
                        Image.asset('asset/images/qr_payment.png', height: 150,),
